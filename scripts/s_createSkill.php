...
$response = $pdo->createSkill($id, $id_group, $id_classe, $id_version, $id_langue, $name, $cost, $spcost, $cooldown, $levelRequired, $prerequisite, $skillLevel, $effects, $controls, $description, $staycolored, $atCreation, $img, $webm, $position_x, $position_y, $awaken);
